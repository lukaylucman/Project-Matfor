      ...
      const build = () => {
        ...
        chars.forEach(ch => {
          ...
          if (shuffleDirection === 'left' || shuffleDirection === 'right') {
            gsap.set(inner, { left: startX, top: 0, force3D: false });
            inner.setAttribute('data-start-x', String(startX));
            inner.setAttribute('data-final-x', String(finalX));
          } else {
            gsap.set(inner, { left: 0, top: startY, force3D: false });
      ...
      const play = () => {
        ...
        const tl = gsap.timeline({
          ...
          onRepeat: () => {
            ...
            if (isVertical) {
              gsap.set(strips, { top: (i, t: HTMLElement) => parseFloat(t.getAttribute('data-start-y') || '0') });
            } else {
              gsap.set(strips, { left: (i, t: HTMLElement) => parseFloat(t.getAttribute('data-start-x') || '0') });
            }
            onShuffleComplete?.();
          },
          onComplete: () => {
        ...
        const addTween = (targets: HTMLElement[], at: number) => {
          ...
          if (isVertical) {
            vars.top = (i: number, t: HTMLElement) => parseFloat(t.getAttribute('data-final-y') || '0');
          } else {
            vars.left = (i: number, t: HTMLElement) => parseFloat(t.getAttribute('data-final-x') || '0');
          }
        ...
        if (animationMode === 'evenodd') {
          ...
          strips.forEach(strip => {
            ...
            if (isVertical) {
              vars.top = parseFloat(strip.getAttribute('data-final-y') || '0');
            } else {
              vars.left = parseFloat(strip.getAttribute('data-final-x') || '0');
            }
            tl.to(strip, vars, d);
